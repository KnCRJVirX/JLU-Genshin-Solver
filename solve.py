...
acw_tc = "ac11000117622408945842374e6a588fd0ea19397c7bf268428f5000000000"

# 构造原始数据
json_payload = {
  "uuid": "thisisuuid&9734",
  "experimentId": 1285,
  "courseId": 11397936,
  "stepId": "",
  "taskId": "9734",
  "recordId": "",
  "platformType": 0,
  "startTime": 1762241517621,
  "endTime": 1762244412621,
  "timeUsed": 2895,
  "status": 1,
  "score": 100,
  "appid": "",
      ...
      "reportContents": [
        {
          ...
          "type": "script",
          "inputs": {},
          "script": "\n回首来时路，经过全党全国各族人民共同努力，我们完成了消除（______）的艰巨任务，我们党在团结带领人民创造美好生活、实现共同富裕的道路上迈出了坚实的一大步。同时，脱贫摘帽不是终点，而是新生活、 新奋斗的起点。脱贫攻坚取得胜利后，接续全面推进乡村振兴，这是“三农”工作重心的历史性转移。巩固拓展（______）成果是全面推进（______）的前提。今年的政府工作 报告指出，巩固拓展脱贫攻坚成果，坚决防止出现规模性返贫。\n输入答案：\n1、绝对贫困\n2、脱贫攻坚\n3、乡村振 兴\n正确答案：\n1、绝对贫困\n2、脱贫攻坚\n3、乡 村振兴\n得分：15\n\n在养殖肉牛的过程中，老乡们可能会遇到过哪些问题？（多选）\n选择的选项：ABC\n正确选项：ABC\n选项：\nA、肉牛长期粪便不成形\nB、肉牛病死 率高\nC、经常丢失肉牛\n得分：5\n\n针对牛品种肉质差，市场价格也偏低，你有什么好办法？(多选)\n选择的选项：ABCD\n正确选项：ABCD\n选项：\nA、引进优质种牛精液，采用人工受精的方式，提升种牛品质，降低繁育生产成本。\nB、改良肉质，提高肉牛单产效益。\nC、拓宽销售渠道 ，如直播卖牛。\nD、牛肉深加工，增加牛肉产品种类。\n得分：5\n请将吉老师和志愿者们的内心独白和正在做的事情拖至对应的框内；（四项；每项5分）\n得分：20分",
          "datas": []
        },
        {
          "name": "操作步骤",
          ...
          "type": "script",
          "inputs": {},
          "script": "1.完成实地调研模块。（得分：10分）\n2.完 成防盗系统研制模块。（得分：10分）\n3.完成改良肉牛质量，拓宽销售渠道模块。（得分：5分）",
          "datas": []
        },
        {
          "name": "三维交互操作",
    ...
    },
    {
      ...
      "reportContents": [
        ...
        },
        {
          ...
          "type": "script",
          "inputs": {},
          "script": "\n任务一：收集粪便所需的工具选择（得分：5分）\n任务二：装载粪便（得分：2分）\n任务三：粪便运输至粪车上（得分：2分）\n任务 四：秸秆打捆（得分：2分 ）\n任务五：秸秆运输至运输车上（得分：2分）\n农田交互：劳作前所需要的物品选择（得分：5）\n误操作次数：0(总分：5分，每错一次扣除1分，最多扣3次)\n正确答案 ：\n1）水鞋，2）大檐帽，3）手套，在这些劳作工具中进行选择。\n农田交互：抛秧间距点选择；（得分：5）\n误操作次数：0(总分：5分，每错一次扣除1分)\n找到并点击选择异常的土地；（得分：5）\n误操作次数：0(总分：5分，每错一次扣除5分)",
          "datas": []
        }
      ]
    },
    {
      ...
      "reportContents": [
        ...
        },
        {
          ...
          "type": "script",
          "inputs": {},
          "script": "1.完成调研当地实况，挖掘乡村文化资源模块。（得分：10 分）\n2.完成了解 非遗现状，培养乡村文化人才模块。（得分：5分）\n3.完成总结特色优势，发展乡村文化产业模块。（得分：5分）",
          "datas": []
        },
        {
          "name": "三维交 互操作",
          ...
          "type": "script",
          "inputs": {},
          "script": "\n1、请在小王家中漫游；找到具有东北特色的物品（得分：20）\n误操作 次数：0(总分：20分，每错一次扣除2分，最多扣5次)\n正确答案：\n1、炕\n2、花棉被\n3、搪瓷茶缸\n4、李锐士剪纸\n5、李向荣木版年画\n6、张玉欣布贴画\n2、请在村 里找到合适的人员；发放宣传单（得分：15）\n误操作次数：0(总分：15分，每错一次扣除3分，最多扣5次)\n正确答案：\n1）家中有小孩子的妇人；\n2）15岁左右的青年；\n3）旅游的游客\n3、请找到并点击选择制作木版画的工具包（得分：10）\n误操作次数：0(总分：10分，每错一次扣除2分，最多扣5次)\n正确答案：\n刻板工具包、印刷工具包、裁纸工具包",
          "datas": []
        }
      ]
    }
